...
function createLanguageOptions({ globals: configuredGlobals, parser, parserOptions }) {
    ...
    return {
        ...
        ecmaVersion: normalizeEcmaVersionForLanguageOptions(parser, ecmaVersion),
        sourceType,
        parser,
        parserOptions
    };
...
function parse(text, languageOptions, filePath) {
    ...
    const parserOptions = Object.assign({}, languageOptions.parserOptions, {
        loc: true,
        range: true,
        raw: true,
        tokens: true,
...
function markVariableAsUsed(scopeManager, currentNode, languageOptions, name) {
    ...
    const specialScope = hasGlobalReturn || languageOptions.sourceType === "module";
    ...
    verify(textOrSourceCode, config, filenameOrOptions) {
        ...
        if (config) {
            if (configType === "flat") {
                ...
                return this._verifyWithFlatConfigArray(textOrSourceCode, configArray, options);
            }
